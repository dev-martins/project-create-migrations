...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ws_orders', function (Blueprint $table) {
            ...
            $table->integer('order_payment')->nullable()->default(1);
            ...
            $table->integer('order_addr')->nullable()->default(null);
            $table->integer('order_shipcode')->nullable()->default(null);
            ...
            $table->integer('order_mail_processing')->nullable()->default(null);
            $table->integer('order_mail_completed')->nullable()->default(null);
            $table->timestamps();
        });
    }
