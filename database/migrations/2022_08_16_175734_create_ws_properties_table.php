...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ws_properties', function (Blueprint $table) {
            ...
            $table->integer('realty_finality')->unsigned()->nullable()->default(null);
            $table->integer('realty_type')->unsigned()->nullable()->default(null);
            ...
            $table->integer('realty_observation')->unsigned()->nullable()->default(null);
            $table->integer('realty_contact')->unsigned()->nullable()->default(null)->index('wc_propertie_author');
