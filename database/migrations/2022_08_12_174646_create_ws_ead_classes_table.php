...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ws_ead_classes', function (Blueprint $table) {
            ...
            $table->integer('video_id')->nullable()->default(null)->foreign('video_id')->references('id')->on('aws_videos')->onDelete('cascade');
            $table->integer('class_time')->nullable()->default(622);
            $table->integer('class_order')->nullable()->default(null);
            ...
            $table->integer('class_support')->nullable()->default(null);
            $table->char('pay', 1)->nullable()->default(0);
            $table->integer('class_number')->nullable()->default(1);
